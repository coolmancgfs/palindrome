...
/**
 ...
 2. Case should be ignored: 'A' should be treated the same as 'a'.
 3. Non-alphanumeric characters should be ignored: Punctuation, spaces, symbols, etc.
 4. If the input string is null, the method must throw an IllegalArgumentException.
...
class Palindrome {
    ...
    public boolean determineIsAnPalindrome(String input) {
        return false;
    }
}
